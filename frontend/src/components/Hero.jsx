        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8 transform hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-2xl md:text-3xl text-gray-700 font-light">
              École de Salsa Cubaine - Montpellier
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="p-6 bg-white/80 backdrop-blur-sm border-orange-200 hover:border-orange-400 transition-all duration-300 hover:shadow-lg hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Authenticité Cubaine</h3>
              <p className="text-gray-600">Apprenez les vrais pas de la salsa cubaine dans le respect de la tradition</p>
            </Card>
