        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <Card className="p-8 bg-white/80 backdrop-blur-sm border-orange-200 shadow-lg">
                ...
                <div className="mt-8 text-center">
                  <Button 
                    ...
                    onClick={() => window.open(`mailto:${contactInfo.email}?subject=Demande d'information - Cours de Salsa&body=Bonjour Aurelien,%0D%0A%0D%0AJe suis intéressé(e) par vos cours de salsa.%0D%0A%0D%0ACordialement,`, '_blank')}
                  >
                    Envoyer un Email
                  </Button>
                </div>
            ...
            <div className="space-y-8">
              ...
              {/* Quick Contact Form */}
              <Card className="p-8 bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-2xl">
                <h3 className="text-3xl font-bold mb-6">Contact Rapide</h3>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium mb-2">Nom</label>
                    <input 
                      type="text" 
                      className="w-full px-4 py-2 rounded-lg text-gray-800 border-0 focus:ring-2 focus:ring-white/50 outline-none"
                  ...
                  <div>
                    ...
                    <textarea 
                      rows={4}
                      className="w-full px-4 py-2 rounded-lg text-gray-800 border-0 focus:ring-2 focus:ring-white/50 outline-none resize-none"
                      placeholder="Votre message..."
                    />
                  </div>
                  <Button 
                    className="w-full bg-white text-orange-600 hover:bg-gray-100 font-semibold py-3 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    onClick={() => alert('Formulaire de contact avec mock data - sera connecté au backend plus tard')}
                  >
                    Envoyer le Message
                  </Button>
                </div>
